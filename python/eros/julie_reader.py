...
class JulieReader:
    ...
    def __init__(self, project_root: Path):
        ...
        self._db_path = (
            self._julie_dir / "indexes" / self._workspace_id / "db" / "symbols.db"
        )
    ...
    def _connect(self) -> sqlite3.Connection:
        """Open a read-only connection to Julie's SQLite database."""
    ...
    def read_all_file_contents(self) -> dict[str, str]:
